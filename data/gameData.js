...
const GAME_DATA = {
  ...
  baseBalls: [
    ...
    { id: "STONE", name: "Stone", nameCn: "岩石", img: "ball_icon_stone.png",
    ...
    { id: "TIME", name: "Time", nameCn: "时间", img: "ball_icon_time.png",
    ...
    { id: "FLESH", name: "Flesh", nameCn: "血肉", img: "ball_icon_flesh.png",
  ...
  evolutions: [
    ...
    { name: "Hemorrhage", nameCn: "血流如注", row: "BLEED", col: "FLESH", img: "ball_icon_hemorrhage.png",
      ...
      effectCn: "施加流血层数。如果敌人身上的流血效果已达上限，击中敌人时将消耗所有流血层数，并造成等同于敌人最大生命值一定百分比的伤害。",
      damageTypes: [DAMAGE_TYPE.BLEED], statusEffects: [STATUS_EFFECT.BLEED], tags: [TAGS.DOT, TAGS.PENETRATE] },
    { name: "Vampire Lord", nameCn: "吸血鬼领主", row: "VAMPIRE", col: "BLEED", img: "ball_icon_vampire_lord.png",
    ...
    { name: "Vampire Lord", nameCn: "吸血鬼领主", row: "VAMPIRE", col: "DARK", img: "ball_icon_vampire_lord.png",
    ...
    { name: "Inferno", nameCn: "炼狱", row: "BURN", col: "TIME", img: "ball_icon_inferno.png",
    ...
    { name: "Radiation Beam", nameCn: "辐射光束", row: "POISON", col: "LASER_H", img: "ball_icon_radiation_beam.png",
      effect: "Emits a radiation beam that deals radiation damage over time.", alt: true,
      effectCn: "激光束会造成辐射伤害。",
    ...
    { name: "Radiation Beam", nameCn: "辐射光束", row: "POISON", col: "LASER_V", img: "ball_icon_radiation_beam.png",
      effect: "Emits a radiation beam that deals radiation damage over time.", alt: true,
      effectCn: "激光束会造成辐射伤害。",
    ...
    { name: "Virus", nameCn: "病毒", row: "POISON", col: "GHOST", img: "ball_icon_virus.png",
      effect: "Applies 1 stack of disease to units it hits. Disease deals damage per second and diseased units have a chance of passing a stack to nearby enemies.", alt: true,
      effectCn: "命中时施加1层瘟疫。每层瘟疫每秒造成伤害，承受瘟疫的敌人有几率向周遭的健康敌人传染瘟疫。",
      damageTypes: [DAMAGE_TYPE.POISON, DAMAGE_TYPE.GHOST], statusEffects: [STATUS_EFFECT.DISEASE], tags: [TAGS.DOT, TAGS.AOE] },
    { name: "Virus", nameCn: "病毒", row: "BLEED", col: "POISON", img: "ball_icon_virus.png",
      effect: "Applies 1 stack of disease to units it hits. Disease deals damage per second and diseased units have a chance of passing a stack to nearby enemies.", alt: true,
      effectCn: "命中时施加1层瘟疫。每层瘟疫每秒造成伤害，承受瘟疫的敌人有几率向周遭的健康敌人传染瘟疫。",
    ...
    { name: "Lovestruck", nameCn: "热恋", row: "CHARM", col: "LIGHTNING", img: "ball_icon_lovestruck.png",
      effect: "Inflicts lovestruck on hit enemies. Lovestruck units have a 50% chance of healing you when they attack.", alt: true,
      effectCn: "对命中的敌人施加热恋。陷入热恋的单位在发起攻击时将有50%几率转而为你恢复生命值。",
      damageTypes: [DAMAGE_TYPE.CHARM, DAMAGE_TYPE.LIGHTNING], statusEffects: [STATUS_EFFECT.LOVESTRUCK], tags: [TAGS.CC, TAGS.DEBUFF] },
    { name: "Lovestruck", nameCn: "热恋", row: "CHARM", col: "TIME", img: "ball_icon_lovestruck.png",
      effect: "Inflicts lovestruck on hit enemies. Lovestruck units have a 50% chance of healing you when they attack.", alt: true,
      effectCn: "对命中的敌人施加热恋。陷入热恋的单位在发起攻击时将有50%几率转而为你恢复生命值。",
    ...
    { name: "Assassin", nameCn: "刺客", row: "IRON", col: "GHOST", img: "ball_icon_assassin.png",
    ...
    { name: "Assassin", nameCn: "刺客", row: "IRON", col: "DARK", img: "ball_icon_assassin.png",
    ...
    { name: "Noxious", nameCn: "毒云", row: "POISON", col: "WIND", img: "ball_icon_noxious.png",
      effect: "Passes through enemies and applies stacks of poison to nearby enemies within a certain tile radius.", alt: true,
      effectCn: "穿过敌人，并且对其周遭一定范围内的所有敌人施加多层中毒。",
      damageTypes: [DAMAGE_TYPE.POISON, DAMAGE_TYPE.WIND], statusEffects: [STATUS_EFFECT.POISON], aoeType: AOE_TYPE.AURA, tags: [TAGS.DOT, TAGS.AOE] },
    { name: "Glacier", nameCn: "冰川", row: "FREEZE", col: "EARTHQUAKE", img: "ball_icon_glacier.png",
    ...
    { name: "Glacier", nameCn: "冰川", row: "FREEZE", col: "STONE", img: "ball_icon_glacier.png",
    ...
    { name: "Sandstorm", nameCn: "沙尘暴", row: "STONE", col: "WIND", img: "ball_icon_sandstorm.png",
    ...
    { name: "Steel", nameCn: "钢铁", row: "IRON", col: "STONE", img: "ball_icon_steel.png",
    ...
    { name: "Drill", nameCn: "钻头", row: "EARTHQUAKE", col: "IRON", img: "ball_icon_drill.png",
    ...
    { name: "Catapult", nameCn: "投石车", row: "STONE", col: "EGG_SAC", img: "ball_icon_catapult.png",
      effect: "Launches stone baby balls periodically.",
      effectCn: "每隔一段时间发射迷你岩石弹珠。",
      damageTypes: [DAMAGE_TYPE.NORMAL], tags: [TAGS.SUMMON] },
    { name: "Landslide", nameCn: "地裂", row: "STONE", col: "EARTHQUAKE", img: "ball_icon_landslide.png",
    ...
    { name: "Brimstone", nameCn: "硫磺", row: "STONE", col: "BURN", img: "ball_icon_brimstone.png",
    ...
    { name: "Brimstone", nameCn: "硫磺", row: "POISON", col: "BURN", img: "ball_icon_brimstone.png",
      effect: "Applies burn and poison to nearby enemies.", alt: true,
      effectCn: "对周围敌人施加燃烧与中毒。",
      damageTypes: [DAMAGE_TYPE.FIRE, DAMAGE_TYPE.POISON], statusEffects: [STATUS_EFFECT.BURN, STATUS_EFFECT.POISON], tags: [TAGS.DOT, TAGS.AOE] },
    { name: "Petrify", nameCn: "石化", row: "STONE", col: "FLESH", img: "ball_icon_petrify.png",
      effect: "Turns enemies to stone.",
      effectCn: "使敌人石化。",
      damageTypes: [DAMAGE_TYPE.NORMAL], tags: [TAGS.CC] },
    { name: "Fireworks", nameCn: "烟火", row: "BURN", col: "EGG_SAC", img: "ball_icon_fireworks.png",
    ...
    { name: "Lightning Bug", nameCn: "闪电虫", row: "LIGHTNING", col: "BROOD_MOTHER", img: "ball_icon_firefly.png",
    ...
    { name: "Venom", nameCn: "毒液", row: "POISON", col: "FREEZE", img: "ball_icon_venom.png",
    ...
    { name: "Heart Swallower", nameCn: "噬心者", row: "BLEED", col: "GHOST", img: "ball_icon_hearteater.png",
    ...
    { name: "Banished Flame", nameCn: "放逐之焰", row: "DARK", col: "BURN", img: "ball_icon_darkflame.png",
    ...
    { name: "Timestop", nameCn: "时间停止", row: "TIME", col: "FREEZE", img: "ball_icon_timestop.png",
    ...
    { name: "Warp", nameCn: "跃迁", row: "TIME", col: "LIGHT", img: "ball_icon_warp.png",
    ...
    { name: "Erosion", nameCn: "侵蚀", row: "TIME", col: "WIND", img: "ball_icon_erosion.png",
    ...
    { name: "Offspring", nameCn: "后代", row: "CELL", col: "FLESH", img: "ball_icon_offspring.png",
      effect: "Splits into multiple flesh baby balls.",
      effectCn: "分裂成多个血肉迷你弹珠。",
      damageTypes: [DAMAGE_TYPE.NORMAL], tags: [TAGS.SUMMON] },
    { name: "Flesh Mound", nameCn: "血肉之丘", row: "BROOD_MOTHER", col: "FLESH", img: "ball_icon_fleshmound.png",
      effect: "Spawns flesh baby balls on hit.",
      effectCn: "命中时生成血肉迷你弹珠。",
      damageTypes: [DAMAGE_TYPE.NORMAL], tags: [TAGS.SUMMON] },
    { name: "Zombie", nameCn: "僵尸", row: "VAMPIRE", col: "FLESH", img: "ball_icon_zombie.png",
  ...
  advancedEvolutions: [
    ...
    { name: "Black Hole", nameCn: "黑洞", components: ["Dark", "Sun"], img: "ball_icon_black_hole.png",
    ...
    { name: "Black Hole", nameCn: "黑洞", components: ["Time", "Sun"], img: "ball_icon_black_hole.png", alt: true,
      effect: "Instantly kills the first non-boss enemy it hits, then destroys itself. Has a 7 second cooldown.",
      effectCn: "在屏幕上创建一个强大的引力奇点，将周围的敌人和投射物全部吸入并湮灭。",
      damageTypes: [DAMAGE_TYPE.DARK], aoeType: AOE_TYPE.AURA, tags: [TAGS.AOE, TAGS.CC] },
    ...
    // === 缺失的高级进化 ===
    { name: "Armageddon", nameCn: "天劫", components: ["Inferno", "Storm"], img: "ball_icon_armageddon.png",
    ...
    { name: "Banshee", nameCn: "尖啸女妖", components: ["Phantom", "Wraith"], img: "ball_icon_banshee.png",
    ...
    { name: "Mosquito Kingdom", nameCn: "蚊群王国", components: ["Mosquito King", "Mosquito Swarm"], img: "ball_icon_mosquitokingdom.png",
      effect: "Spawns massive mosquito army.",
      effectCn: "生成大量蚊子大军，提供强大的吸血和伤害能力。",
      damageTypes: [DAMAGE_TYPE.VAMPIRE], tags: [TAGS.SUMMON, TAGS.LIFESTEAL] },
    { name: "Reaper", nameCn: "死神", components: ["Soul Sucker", "Heart Swallower"], img: "ball_icon_reaper.png",
    ...
    { name: "Sniper", nameCn: "狙击手", components: ["Shotgun", "Assassin"], img: "ball_icon_sniper.png",
    ...
    { name: "Time Bomb", nameCn: "时间炸弹", components: ["Time", "Bomb"], img: "ball_icon_timebomb.png",
      effect: "Throws time bombs that explode after a delay.",
      effectCn: "每隔数秒投掷一枚时间炸弹，炸弹将在延迟后引爆。",
      damageTypes: [DAMAGE_TYPE.BOMB], aoeType: AOE_TYPE.BOMB, tags: [TAGS.AOE] },
    { name: "Tumor", nameCn: "肿瘤", components: ["Radiation Beam", "Flesh"], img: "ball_icon_tumor.png",
    ...
    { name: "X Ray", nameCn: "X射线", components: ["Holy Laser", "Laser Beam"], img: "ball_icon_xray.png",
    ...
    { name: "Elemental", nameCn: "元素", components: ["Burn", "Wind", "Freeze", "Earthquake"], img: "ball_icon_elemental.png",
  ...
  baseItems: [
    ...
    { name: "Voodoo Doll", nameCn: "巫毒人偶", img: "voodooDoll.png",
      ...
      effectCn: "诅咒有几率杀死敌人。" },
    // === 缺失的基础被动道具 ===
    { name: "Wagon Wheel", nameCn: "马车轮", img: "wagonWheel.png",
      effect: "Balls bounce more.",
      effectCn: "弹珠反弹更多次。" },
    { name: "Hourglass", nameCn: "沙漏", img: "hourglass.png",
      effect: "Time-related effects last longer.",
      effectCn: "时间相关效果持续更久。" },
    { name: "Silver Bullet", nameCn: "银子弹", img: "silverBullet.png",
      effect: "Balls deal bonus damage to certain enemies.",
      effectCn: "弹珠对特定敌人造成额外伤害。" },
    { name: "Hand Mirror", nameCn: "手镜", img: "handMirror.png",
      effect: "Reflect enemy projectiles.",
      effectCn: "反射敌人的投射物。" },
    { name: "Turret", nameCn: "炮塔", img: "turret.png",
      effect: "Deploy turrets that attack enemies.",
      effectCn: "部署攻击敌人的炮塔。" },
    { name: "Hand Fan", nameCn: "手扇", img: "handFan.png",
      effect: "Push enemies back.",
      effectCn: "推开敌人。" },
    { name: "Iron Onesie", nameCn: "铁甲连身衣", img: "passive_irononesie.png",
      effect: "Increase armor.",
      effectCn: "增加护甲。" },
    { name: "Sword Breaker", nameCn: "碎剑器", img: "passive_swordbreaker.png",
      effect: "Break enemy weapons.",
      effectCn: "破坏敌人的武器。" },
    { name: "Platinum Dumbbell", nameCn: "白金哑铃", img: "passive_dumbbell.png",
      effect: "Increase ball damage.",
      effectCn: "增加弹珠伤害。" },
    { name: "Pressure Valve", nameCn: "压力阀", img: "pressureValve.png",
      effect: "Control explosion timing.",
      effectCn: "控制爆炸时机。" },
    { name: "Magnet", nameCn: "磁铁", img: "magnet.png",
      effect: "Attract items and enemies.",
      effectCn: "吸引物品和敌人。" },
    { name: "Bottled Tornado", nameCn: "瓶装龙卷风", img: "bottledTornado.png",
      effect: "Release tornado on hit.",
      effectCn: "命中时释放龙卷风。" },
    { name: "Slingshot", nameCn: "弹弓", img: "slingshot.png",
  ...
  passiveEvolutions: [
    ...
    { name: "Tormenters Mask", nameCn: "处刑者的面具", components: ["Spiked Collar", "Crown of Thorns"], img: "tormentersMask.png",
    ...
    { name: "Deadeye's Cross", nameCn: "靶眼十字架", components: ["Diamond-Hilted Dagger", "Emerald-Hilted Dagger", "Ruby-Hilted Dagger", "Sapphire-Hilted Dagger"], img: "deadeyesCross.png",
      ...
      effectCn: "大幅提升暴击率。" },
    // === 缺失的被动道具进化 ===
    { name: "Deadeye's Impaler", nameCn: "靶眼穿刺枪", components: ["Deadeye's Cross", "Gracious Impaler"], img: "passive_impaler.png",
      effect: "Critical hits have a higher chance to instantly kill enemies.",
      effectCn: "暴击有更高几率立即击杀敌人。" },
    { name: "Ardent Tire", nameCn: "炽热轮胎", components: ["Wagon Wheel", "Rubber Headband"], img: "passive_tire.png",
      effect: "Balls bounce faster and deal more damage.",
      effectCn: "弹珠反弹更快并造成更多伤害。" },
    { name: "Argent Stopwatch", nameCn: "银色秒表", components: ["Hourglass", "Silver Bullet"], img: "passive_stopwatch.png",
      effect: "Time-based abilities are enhanced.",
      effectCn: "时间相关能力得到强化。" },
    { name: "Arrow of Fate", nameCn: "命运之箭", components: ["Lover's Quiver", "Hand Mirror"], img: "passive_arrow.png",
      effect: "Projectiles have enhanced effects.",
      effectCn: "投射物效果增强。" },
    { name: "Full Metal Rapier", nameCn: "全金属刺剑", components: ["Iron Onesie", "Sword Breaker"], img: "passive_rapier.png",
      effect: "Melee attacks are more effective.",
      effectCn: "近战攻击更加有效。" },
    { name: "Grotesque Artillery", nameCn: "怪诞火炮", components: ["Turret", "Hand Fan"], img: "passive_artillery.png",
      effect: "Turret attacks are enhanced.",
      effectCn: "炮塔攻击增强。" },
    { name: "Inglorious Hammer", nameCn: "无名铁锤", components: ["Platinum Dumbbell", "Upturned Hatchet"], img: "passive_hammer.png",
      effect: "Heavy attacks deal more damage.",
      effectCn: "重击造成更多伤害。" },
    { name: "Remote Detonator", nameCn: "远程引爆器", components: ["Pressure Valve", "Magnet"], img: "passive_detonator.png",
      effect: "Explosions can be triggered remotely.",
      effectCn: "可以远程触发爆炸。" },
    { name: "Windweaver", nameCn: "织风者", components: ["Bottled Tornado", "Slingshot"], img: "passive_windweaver.png",
