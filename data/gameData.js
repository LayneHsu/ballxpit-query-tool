...
const STRATEGIES = [
  ...
  {
    id: "flash_vampire_immortal",
    name: "Infinite Blood Pool",
    nameCn: "无限血池",
    type: SYNERGY_TYPE.SUSTAIN,
    difficulty: 2,
    rating: 5,
...
const GAME_DATA = {
  ...
  evolutions: [
    ...
    { name: "Radiation Beam", nameCn: "辐射光束", row: "CELL", col: "LASER_V", img: "ball_icon_radiation_beam.png",
      effect: "Emits a radiation beam that deals radiation damage over time.", alt: true,
      effectCn: "激光束会造成辐射伤害。",
    ...
    { name: "Freeze Ray", nameCn: "冰冻射线", row: "FREEZE", col: "LASER_V", img: "ball_icon_freeze_ray.png",
    ...
    { name: "Blizzard", nameCn: "暴风雪", row: "FREEZE", col: "LIGHTNING", img: "ball_icon_blizzard.png",
      effect: "Freezes all enemies within a 2 tile radius for 0.8 seconds, dealing 1-50 damage.", alt: true,
      effectCn: "在小范围内冻结所有敌人，并造成伤害。",
    ...
    { name: "Laser Beam", nameCn: "激光束", row: "LASER_V", col: "LIGHT", img: "ball_icon_laser_beam.png",
